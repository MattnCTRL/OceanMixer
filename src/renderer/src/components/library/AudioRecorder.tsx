...
import { Mic, Square, Loader2, X, CircleDot, Info } from 'lucide-react'
...
export function AudioRecorder({
  ...
  const finalize = useCallback(async () => {
    ...
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [elapsed, placeOnTimeline, onClose, teardown, stopMeters])
  ...
  return (
    <div
      ...
      onMouseDown={(e) => {
        if (e.target === e.currentTarget && !recording && !saving) onClose()
      }}
      role="dialog"
      aria-modal="true"
